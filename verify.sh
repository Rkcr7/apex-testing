...
echo ""
echo "  Benchmark speed is the standard comparison metric — data pre-loaded"
echo "  in RAM, no file I/O, same as lzbench/Squash/zstd benchmarks."
echo "  CLI wall-clock includes ~630ms CUDA driver loading per invocation"
echo "  (one-time cost, not present in long-running processes)."
